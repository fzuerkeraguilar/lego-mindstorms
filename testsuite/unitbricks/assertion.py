...
def assert_less(max, given, name=""):
    if given >= max:
        raise AssertionError(
            f"Assertion: expected less than {max} but got {given}: {name}"
        )
...
def assert_less_equals(max, given, name=""):
    if given > max:
        raise AssertionError(
            f"Assertion: expected less than or equals {max} but got {given}: {name}"
        )
...
def assert_more(min, given, name=""):
    if given <= min:
        raise AssertionError(
            f"Assertion: expected more than {min} but got {given}: {name}"
        )
...
def assert_more_equals(min, given, name=""):
    if given < min:
        raise AssertionError(
            f"Assertion: expected more than or equals {min} but got {given}: {name}"
        )
